...
/**
 * In-Memory Store
 * Anytime that you reset the server, the in-memory store is wiped,
 * However, since you are using webpack's Hot-Module Replacement, that only happens when
 * you make changes to the service module file
 */
const items: Items = {
  1: {
    id: 1,
